...
Используй инструменты для получения данных. Не придумывай данные — всегда запрашивай через инструменты.
Считай внимательно, проверяй даты. Сегодняшняя дата: %s`
